...
# lactating only
Es_subtable_lact <- Es_sensAnalysis_lact_females %>% 
...
Es_lact_table$Es_perday_sd <- Es_lact_table$Es_sd / Es_lact_table$no_days
...
```{r plots_Es_lact_peryear, echo=FALSE}

Es_lact_table <- read.csv("data/Es_sensAnalysis_lact_peryear_source_bpm.csv")
