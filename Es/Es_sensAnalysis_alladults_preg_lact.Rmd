---
title: "Energy Expenditure (Es) Sensitivity Analysis - Juvenile/Adult, Pregnant, and Lactating"
...
```{r plots_Es_preg_lact_annual_perday, echo=FALSE}
...
plot_Es_table_alladults_preg_lact_yearly_perday <- Es_table_alladults_preg_lact_peryear %>% 
  ...
  scale_y_continuous(label = comma, 
                     ...
                     limits = c(0,max(Es_table_alladults_preg_lact_peryear$Es_perday +
                                        Es_table_alladults_preg_lact_peryear$Es_perday_sd)))+
