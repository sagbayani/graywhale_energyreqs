...
datapath <- paste0(getwd(), "/data_for_charts", collapse = NULL) 
datapath
...
P_cost_table  <-  read_csv("data_for_charts/P_cost_table_phase1.csv")
...
P_cost_table_peryear  <- read_csv("data_for_charts/P_cost_table_peryear.csv")
...
Es_table_phase1_permth  <-  read_csv("data_for_charts/Es_sensAnalysis_phase1_permth_source_bpm.csv")
...
Es_table_alladults_preg_lact_peryear  <- 
  read_csv("data_for_charts/Es_sensAnalysis_alladults_preg_lact_peryear_source_bpm.csv")
...
predict_GER_table_phase1_permth <- read_csv("data_for_charts/predict_GER_table_sensAnalysis_phase1_permth_source_bpm.csv")
...
predict_GER_table_phase2 <- 
  read_csv("data_for_charts/predict_GER_table_sensAnalysis_phase2.csv")
...
predict_GER_table_3panel  <- read_csv("data_for_charts/predict_GER_table_all_preg_lact_source_bpm.csv")
...
pct_bodyweight_all <-  read_csv("data_for_charts/pct_bodyweight_all_lact_preg.csv")
...
predict_GER_table_sensAnalysis_phase1_permth  <-  read_csv("data_for_charts/predict_GER_table_sensAnalysis_phase1_permth_source_bpm.csv")
...
predict_GER_table_sensAnalysis_phase2 <- read_csv("data_for_charts/predict_GER_table_sensAnalysis_phase2.csv")
...
predict_GER_table_sensAnalysis_preg <-
  as_tibble(read_csv("data_for_charts/predict_GER_table_sensAnalysis_preg.csv"))
...
#Read in data_for_charts
predict_GER_table_sensAnalysis_lact <-
  as_tibble(read_csv("data_for_charts/predict_GER_table_sensAnalysis_lact.csv"))
...
Es_sensAnalysis_phase1_permth <-  read_csv("data_for_charts/Es_sensAnalysis_phase1_permth_source_bpm.csv")
...
Es_sensAnalysis_alladults_preg_lact_peryear <-
  as_tibble(read_csv("data_for_charts/Es_sensAnalysis_alladults_preg_lact_peryear_source_bpm.csv"))
...
plot_Es_sensAnalysis_alladults_preg_lact_yearly_perday <-
  ...
  geom_errorbar(aes(x = age_yrs, ymin = Es_perday - Es_sd_perday, ymax = Es_perday + Es_sd_perday),
                size = 0.5, colour = 'gray60', width = 0, linetype = 1) +
  # geom_ribbon(aes(x = age_yrs, ymin = Es - Es_sd, ymax = Es + Es_sd),
  #                 fill = 'gray40', alpha = 0.3) +
  geom_point(size = 1)+
  #geom_line()   +
...
Es_sensAnalysis_phase2_peryear <-  read_csv("data_for_charts/Es_sensAnalysis_phase2_peryear_source_bpm.csv")
...
```{r plots_Es_phase2_stacked, echo=FALSE}

Es_sensAnalysis_phase2 <- read_csv("data_for_charts/Es_sensAnalysis_phase2_source_bpm.csv")
...
Es_sensAnalysis_alladults_preg_lact_peryear %>% read_csv("data_for_charts/Es_sensAnalysis_alladults_preg_lact_peryear_source_bpm.csv")
...
plot_Es_sensAnalysis_alladults_preg_lact_yearly_perday <- Es_sensAnalysis_alladults_preg_lact_peryear %>%
  ggplot(aes(x = age_yrs, y =Es_perday)) + #shape = Lifestage
  facet_grid(Lifestage_f ~ MC_variable, labeller = label_wrap_gen(width = 2, multi_line = TRUE))+
  geom_errorbar(aes(x = age_yrs, ymin = Es_perday - Es_sd_perday, ymax = Es_perday + Es_sd_perday),
...
```{r Es_preg_stacked, echo=FALSE}

#read in preg  table. 
Es_sensAnalysis_preg  <-  read_csv("data_for_charts/Es_sensAnalysis_preg_source_bpm.csv")
...
```{r Es_lact_stacked, echo=FALSE}

#read in lact  table. 
Es_sensAnalysis_lact  <-  read_csv("data_for_charts/Es_sensAnalysis_lact_females_source_bpm.csv")
